...
(5, '2022_08_27_082109_create_stdudent_models_table', 1);
...
--
-- Table structure for table `stdudent_models`
--

CREATE TABLE `stdudent_models` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `stdudent_models`
--
...
--
-- Indexes for table `stdudent_models`
--
